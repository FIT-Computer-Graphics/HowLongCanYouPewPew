...
public class EnemyController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            mainCam = GameObject.FindGameObjectWithTag("MainCamera").GetComponent<UnityEngine.Camera>();
        ...
        private void CalculateMarker()
        {
            ...
            switch (screenPos.x)
            {
                ...
                default:
                {
                    ...
                    {
                        screenPos.x = Screen.width - Screen.width * 0.09f;
                    }
            ...
            switch (screenPos.y)
            {
                ...
                default:
                {
                    ...
                    {
                        screenPos.y = Screen.height - Screen.height * 0.09f;
                    }
